        ...
        <div className="w-full min-h-screen px-10 py-5">
            <div className="w-full">
                <div className="w-full flex items-center justify-center flex-col gap-5 px-4 py-5">
                    <h2 className="heading text-4xl text-4md text-[#e95d5d] font-semibold ">
                        You May Like One Of Our Products
                    </h2>
                ...
                <div className="product-container min-h-screen  gap-10">
                    {dataList &&
                        dataList.map((item, index) => (
                            <Link to={`single-product/${item.id}`} className="productcard w-[250px] h-[330px] cursor-pointer  " key={index}>
                                ...
                                <div className="w-full h-full ">
                                    <h4 className="text-2xl font-bold px-2">
                                        {item.ProductName}
                                    </h4>
                                    <div className="flex items-center justify-between ">
                                        ...
                                        <div>
                                            {" "}
                                            <Link className="px-3 text-[16px] rounded-xl py-1 bg-red-500 text-white ">
                                                Click Me
                                            </Link>
                                        </div>
                                    </div>
